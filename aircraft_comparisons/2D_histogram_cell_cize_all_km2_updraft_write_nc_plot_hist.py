...
out_file = data_path+'netcdf_summary_files/aircraft_comparisons/Convective_cell_size_all_3D_WP_less_than_1eminus1_cloud_mass_less_than_1eminus6.nc'
ncfile1 = nc.Dataset(out_file,mode='w',format='NETCDF4_CLASSIC')
index = ncfile1.createDimension('index',None)
cell_size = ncfile1.createVariable('Convective_cell_size_all_WP<1e-1_cloud_mass<1e-6', np.float32, ('index',))
cell_size.units = 'km^2'

out_file = data_path+'netcdf_summary_files/aircraft_comparisons/Updrafts_cell_size_all_3D_WP_less_than_1eminus1_cloud_mass_less_than_1eminus6.nc'
ncfile2 = nc.Dataset(out_file,mode='w',format='NETCDF4_CLASSIC')
index = ncfile2.createDimension('index',None)
updrafts = ncfile2.createVariable('Updrafts_cell_size_all_WP<1e-1_cloud_mass<1e-6', np.float32, ('index',))
updrafts.units = 'm/s'
...
plt.savefig(fig_dir+'cell_size_all_v_updraft_in_clouds.png', dpi=300)
plt.show()
