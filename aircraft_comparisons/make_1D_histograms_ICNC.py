...
ice_7000 = TOTAL_ICE_NUMBER[ALT<8000]
alt_7000 = ALT[ALT<8000]
ice_7000 = ice_7000[alt_7000>7000]

air_7000 = air_2ds[air_alt<8000]
alt_7000 = air_alt[air_alt<8000]
air_7000= air_7000[alt_7000>7000]
ra.plot_1d_histogram_aircraft_and_model(air_7000,ice_7000,'Ice number / 2ds count (7000-8000m) (/cm^3)', 'TOTAL_ICE_NUMBER_model_7000_to_8000m_1D_histogram_new_RC_data', model_path)

ice_7000 = TOTAL_ICE_NUMBER[ALT<7000]
alt_7000 = ALT[ALT<7000]
#ice_7000 = ice_7000[alt_7000>7000]

air_7000 = air_2ds[air_alt<7000]
alt_7000 = air_alt[air_alt<7000]
#air_7000= air_7000[alt_7000>7000]
ra.plot_1d_histogram_aircraft_and_model(air_7000,ice_7000,'Ice number / 2ds count (<7000m) (/cm^3)', 'TOTAL_ICE_NUMBER_model_under_7000m_1D_histogram_new_RC_data', model_path)
