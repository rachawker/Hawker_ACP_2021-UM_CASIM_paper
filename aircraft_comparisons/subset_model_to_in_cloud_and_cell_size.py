...
def subset_model(data_path,FILE_TYPE,STASH_CODE,VARIABLE_NAME,LOWER_SIZE,UPPER_SIZE):
    ...
    for t in np.arange(start_time*60,end_time*60-1,dt_output[m]):
      ...
      cloud_mass = liquid_water_mm+ice_water_mmr
    ...
    out_file = data_path+'netcdf_summary_files/aircraft_comparisons/' + VARIABLE_NAME +'_cell_size_'+str(LOWER_SIZE)+'_to_'+str(UPPER_SIZE)+'_3D_WP_less_than_1eminus10_cloud_mass_less_than_1eminus6_WITH_RAIN.nc'
