...
rads = ['Percentage_of_grid_points_with_surface_rain', 'Precipitation_at_surface_max','Precipitation_at_surface_domain_mean','Precipitation_at_surface_raining_mean','Accumulated_precipitation_approx']
rad_title = ['Percentage of grid points with surface rain', 'Precipitation at surface max','Precipitation at surface domain mean','Precipitation at surface raining mean','Accumulated precipitation']
rad_name = ['Percentage_of_grid_points_with_surface_rain', 'Precipitation_at_surface_max','Precipitation_at_surface_domain_mean','Precipitation_at_surface_raining_mean','Accumulated_precipitation']
...
for r in range(0, len(rads)):
  csv_name = 'Average'+rads[r]
  array = np.zeros((10,1))
  csv_name2 = 'HM_minus_noHM_'+rads[r]+'_difference'
  array2 = np.zeros((5,1))
  fig = plt.figure()
  ...
  for f in range(0,len(list_of_dir)):
    ...
    hfile=HM_data_path+'/um/netcdf_summary_files/surface_precipitation.nc'
