...
csv_dir = '/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_time_series/cirrus_and_anvil/csv_files/radiation/het_minus_nohet/'
...
label = rl.labels
csv_name = 'het_minus_nohet_LW_SW_mean_radiation_DIFFERENCE_for_each_and_combinations_low_mid_high_cloud'
array = np.zeros((5,16))
...
label = rl.labels
csv_name = 'het_minus_nohet_LW_SW_TOTAL_radiation_DIFFERENCE_for_each_and_combinations_low_mid_high_cloud'
array = np.zeros((5,18))
for f in range(0,len(list_of_dir)-1):
  data_path = list_of_dir[f]
  print data_path
