...
cloud_fracs = ['fraction_of_cloudy_arealow_cloud','fraction_of_cloudy_arealow_mid_cloud','fraction_of_cloudy_arealow_mid_high_cloud','fraction_of_cloudy_arealow_high_cloud','fraction_of_cloudy_areamid_cloud','fraction_of_cloudy_areamid_high_cloud','fraction_of_cloudy_areahigh_cloud']
...
label = rl.labels
csv_name = 'cloud_fraction_and_cover/het_minus_nohet_freezing/het_minus_nohet_INCLUDES_TOTAL_CLOUD_COVER_CHANGE_each_and_combinations_low_mid_high_cloud'
array = np.zeros((5,8))
...
csv_name = 'cloud_fraction_and_cover/het_minus_nohet_freezing/het_minus_nohet_DOMAIN_CLOUD_FRACTION_DIFFERENCE_each_and_combinations_low_mid_high_cloud'
array = np.zeros((5,8))

cloud_fracs = ['fraction_of_total_domainlow_cloud','fraction_of_total_domainlow_mid_cloud','fraction_of_total_domainlow_mid_high_cloud','fraction_of_total_domainlow_high_cloud','fraction_of_total_domainmid_cloud','fraction_of_total_domainmid_high_cloud','fraction_of_total_domainhigh_cloud']
for f in range(0,len(list_of_dir)-1):
  data_path = list_of_dir[f]
  print data_path
  rfile = data_path+cloud_fracs_file
