...
no_inp_path = '/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/HOMOG_and_HM_no_het/um/'
no_inp_name = 'HOMOG_and_HM_no_het_'
file_name = name+'pc'+date+'.pp'
input_file = data_path+file_name
print input_file
file_name2 = no_inp_name+'pc'+date+'.pp'
input_file2 = no_inp_path+file_name2
