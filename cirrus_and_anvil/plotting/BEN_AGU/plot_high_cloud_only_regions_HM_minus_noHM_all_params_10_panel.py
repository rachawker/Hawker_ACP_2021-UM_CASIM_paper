...
data_paths = rl.list_of_dir[0:5]
names = ['Cooper1986_','Meyers1992_','DeMott2010_','Niemand2012_','Atkinson2013_']
titles = ['C86','M92','D10','N12','A13']
date = '00100005'

fig, ((ax1, ax2, ax3, ax4, ax5), (ax6, ax7, ax8, ax9, ax10)) = plt.subplots(2,5, subplot_kw={'projection': ccrs.PlateCarree()}, figsize = (20,9))
  ###PLOT MODEL DATA
...
print 'Save figure'
fig_name = fig_dir + 'High_cloud_2D_HM_minus_noHM_difference_10_panel_'+date+'.png'
