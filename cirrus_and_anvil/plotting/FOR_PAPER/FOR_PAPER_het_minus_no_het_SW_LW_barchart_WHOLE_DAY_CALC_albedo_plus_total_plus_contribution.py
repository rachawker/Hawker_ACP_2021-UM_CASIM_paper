...
fig_dir = '/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_time_series/FOR_PAPER/'#rl.cirrus_and_anvil_fig_dir
...
axa.set_title('(b.) Longwave radiation')
...
fig_name = fig_dir + 'WHOLE_TIME_FOR_PAPER_BAR_CHART_cloud_contributions_and_total_radiation_difference_het_minus_nohet_diff.png'
fig.tight_layout()
