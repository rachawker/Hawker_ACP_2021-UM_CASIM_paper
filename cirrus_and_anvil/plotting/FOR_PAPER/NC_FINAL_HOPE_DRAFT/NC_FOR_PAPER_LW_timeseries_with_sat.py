...
fig, ((axs1,axs2),(ax1, ax2)) = plt.subplots(2,2, subplot_kw={'projection': ccrs.PlateCarree()}, figsize = (5,4.0))##,(ax3, ax4),(ax5, ax6)) = plt.subplots(4,2, subplot_kw={'projection': ccrs.PlateCarree()}, figsize = (4.8,6.7))#10))
...
fig.subplots_adjust(right=0.8)
cbar_ax = fig.add_axes([0.82, 0.15, 0.03, 0.28])  #left, bottom, width, height as fractions of figure dimensions
cbar =  fig.colorbar(cs, cax=cbar_ax)
cbar.set_label("Outgoing TOA longwave\nradiation" + rl.W_m_Sq)
...
print 'Save figure'
fig_name = fig_dir + 'LW_timeseries_'+abbrev+'_only_sat_times.png'
