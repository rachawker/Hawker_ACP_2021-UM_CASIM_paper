...
axhom.set_title('(c) '+ mass_title[r]+' (in cloud)', fontsize=9)
x = []
...
for r in range(1, 2):
  ...
  axhom.set_title('(b) '+mass_title[r]+' (out of cloud)', fontsize=9)

fig.tight_layout()
fig_name = fig_dir + 'SI_FOR_PAPER_NAT_COMMS_T_RH_W.png'
