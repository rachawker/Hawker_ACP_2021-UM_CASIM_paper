...
fig_dir = '/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_time_series/FOR_PAPER/NAT_COMMS_FINAL_DRAFT/SI/'#rl.cirrus_and_anvil_fig_dir
...
axb.set_title('(a.) Outgoing shortwave: INP impact')
axa.set_title('(b.) Outgoing longwave: INP impact')
