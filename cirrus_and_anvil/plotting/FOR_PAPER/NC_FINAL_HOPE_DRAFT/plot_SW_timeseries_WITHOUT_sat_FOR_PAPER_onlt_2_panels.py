...
dates = ['00103005','00133005','00150005','00163005','00180005','00193005','00210005','00223005','00234505']
titles = ['10:30','13:30','15:00','16:30','18:00','19:30','21:00','22:30','23:45']
#fig, ((axs1,axs2),(ax1, ax2), (ax3, ax4), (ax5, ax6)) = plt.subplots(8,2, subplot_kw={'projection': ccrs.PlateCarree()}, figsize = (20,5))
fig, ((ax1, ax2)) =plt.subplots(1,2, subplot_kw={'projection': ccrs.PlateCarree()}, figsize = (5,3))
...
fig.subplots_adjust(right=0.8)
cbar_ax = fig.add_axes([0.82, 0.2, 0.03, 0.6])  #left, bottom, width, height as fractions of figure dimensions
cbar =  fig.colorbar(cs, cax=cbar_ax)
cbar.set_label("Outgoing TOA shortwave\nradiation" + rl.W_m_Sq)
...
print 'Save figure'
fig_name = fig_dir + 'SW_timeseries_WITHOUT_SAT_'+abbrev+'_only_sat_times.png'
