...
fig, ((axs1,axs2),(ax1, ax2),(ax3, ax4),(ax5, ax6)) = plt.subplots(4,2, subplot_kw={'projection': ccrs.PlateCarree()}, figsize = (4.8,7))
...
cbar.set_label("Outgoing TOA shortwave" + rl.W_m_Sq)
...
print 'Save figure'
fig_name = fig_dir + 'SW_timeseries_'+abbrev+'.png'
