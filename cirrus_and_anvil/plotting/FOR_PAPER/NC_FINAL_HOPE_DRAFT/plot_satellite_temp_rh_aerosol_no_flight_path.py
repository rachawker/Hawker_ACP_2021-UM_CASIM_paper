...
data_path = sys.argv[1]  # directory of model output SYSs: /group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/Niemand2012/um/ Niemand2012_ N12 Aqua_BIG

fig_dir = '/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_time_series/FOR_PAPER/NAT_COMMS_FINAL_DRAFT/'#/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_time_series/FOR_PAPER/'
...
#ax2.set_xlim(0,250)
#ax0 = ax2.twiny()
ax2.plot(b933_aer/1e8,b933_z,c='k', label='Aircraft all', zorder=10)
ax2.plot(model_total_acc/1e8,z,c='red',label='Model all', zorder=10)
ax2.plot(ac_sol/1e8,z,c='red',linestyle=':', label='Model\nsoluble', zorder=10)
ax2.plot(ac_insol/1e8,z,c='red',linestyle='--', label='Model\ninsoluble', zorder=10)
#ax2.plot(model_total_acc/1e8,z,c='red',label='Model total', zorder=10)
ax2.legend(ncol=1,loc='upper right')

'''
par2.plot(ac_sol/1e8,z,c='red',linestyle=':', label='Soluble', zorder=10)
par2.plot(ac_insol/1e8,z,c='red',linestyle='--', label='Insoluble', zorder=10)
par2.plot(model_total_acc/1e8,z,c='red',label='Total', zorder=10)
par2.legend(ncol=1,loc='upper right')
'''
ax2.set_xlabel('Aerosol number\nconcentration ('+r"$\mathrm{10{^8}}$"+' '+r" $\mathrm{m{^-}{^3}}$"+')')
...
a,b = ax2.get_xlim()
#par2.set_xlim(a,b)
#par2.set_xlabel('Modelled ('+r"$\mathrm{10{^8}}$"+' '+r" $\mathrm{m{^-}{^3}}$"+')', color='red')
#par2.tick_params(axis='x', colors='red')
ax2.set_title('(b.) Aerosol concentration')
'''
...
axhom.set_xlabel('Temperature '+rl.degrees_C)#rl.Kelvin)
...
height = nc1.variables['height']
height = height[:]/1000
par2.plot(fr1,height,c='red', linewidth=1.2, linestyle='-',label='Temperature')
par2.xaxis.set_label_position('bottom')
par2.xaxis.set_ticks_position('bottom')
par2.set_xlabel('RH (%)', color='red')
...
#ax3.sharey(ax2)
ax3.set_title('(c.) Modelled conditions')
