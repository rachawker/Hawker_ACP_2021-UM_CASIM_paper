...
axhom.set_title('(a.) Ice crystal water path')#, fontsize=8)
...
axhom.set_ylabel('Number concentration '+rl.per_m_cubed_div_by_1000000, labelpad=10)
axhom.locator_params(nbins=5, axis='x')
axhom.set_title('(b.) CDNC at 5 km')#, fontsize=8)
...
axhom.text(0.05, 0.05, textstr, transform=axhom.transAxes,
        verticalalignment='bottom')
axhom.set_ylabel('Mass concentration '+rl.kg_per_m_cubed_div_by_minus_100000, labelpad=10)
axhom.locator_params(nbins=5, axis='x')
axhom.set_title('(c.) Cloud drop mass at 5 km')#, fontsize=8)
axc.set_xticklabels([])
...
fig_name = fig_dir + 'FOR_PAPER_NAT_COMMS_MPHYSSLOPEFIG.png'
fig.tight_layout()
#fig.subplots_adjust(wspace=0, hspace=1)
