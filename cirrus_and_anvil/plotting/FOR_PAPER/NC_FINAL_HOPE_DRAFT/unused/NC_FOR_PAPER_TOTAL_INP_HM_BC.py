...
axc.legend(handles=x,loc='upper left',ncol=3, fontsize=9)
fig_name = fig_dir + 'FOR_PAPER_BAR_CHART_INP_and_HM_total_radiation_difference.png'
fig.tight_layout()
