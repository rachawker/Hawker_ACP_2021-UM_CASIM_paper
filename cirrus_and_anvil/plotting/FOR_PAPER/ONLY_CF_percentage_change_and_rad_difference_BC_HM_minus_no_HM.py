...
#cloud fraction
#ax1 = plt.subplot2grid((5,6),(0,0),rowspan=3,colspan=2)#(2,3),(0,0),rowspan=2)
#cloud fraction change barchart
axb = plt.subplot2grid((2,3),(1,0),colspan=2)#(2,3),(0,1))#,colspan=2)
...
#total outgoing rad
axd = plt.subplot2grid((2,3),(0,0),colspan=3)
axf = plt.subplot2grid((2,3),(1,2))
barWidth = 0.13
...
axb.set_ylabel(r'$\Delta$'+ ' Cloud cover (%)')#, fontweight='bold')
axb.set_title('(b.) Cloud fraction')
...
fig_name = fig_dir+'/only_CF_percentage_change_and_rad_BC_HM_minus_noHM_diff.png'
