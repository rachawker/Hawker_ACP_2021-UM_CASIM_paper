...
axh.set_title(rl.capH+' Anvil: SIP impact')
...
axg.set_title(rl.capG+' Anvil: INP impact')
...
axc.set_title(rl.capC+' M92: 20:00')
axa.set_title(rl.capA + ' NoINP: 20:00')#'('+r"$\bf{A}$"+') NoINP: 20:00')
axb.set_title(rl.capB+' C86: 20:00')
axd.set_title(rl.capD+' D10: 20:00')
axe.set_title(rl.capE+' N12: 20:00')
axf.set_title(rl.capF+' A13: 20:00')
...
fig_name = fig_dir + 'FOR_PAPER_SCI_ADV_2D_cloud_type_ANVIL_CF_change.png'
fig.tight_layout()
