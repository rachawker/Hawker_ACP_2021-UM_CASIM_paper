...
axhom.set_ylim(0,16)
axhom.set_title(rl.capA+' Cloud fraction')
...
axhom.set_ylabel('Number concentration '+rl.per_m_cubed_div_by_100000, labelpad=10)
axhom.locator_params(nbins=5, axis='x')
axhom.set_title(rl.capB+' ICNC at 10 km')#, fontsize=8)
...
axhom.locator_params(nbins=5, axis='x')
axhom.set_title(rl.capC+' Ice/(snow + graupel) at 12 km')#, fontsize=8)
#axc.set_xticklabels([])
...
fig_name = fig_dir + 'FOR_PAPER_SCI_ADV_CFFIG.png'
fig.tight_layout()
#fig.subplots_adjust(wspace=0, hspace=1)
