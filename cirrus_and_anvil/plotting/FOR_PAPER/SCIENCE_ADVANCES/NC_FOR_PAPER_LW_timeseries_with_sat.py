...
fig_dir = '/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_time_series/FOR_PAPER/SCIENCE_ADVANCES/'
...
dates = ['00103005','00133005','00154505','00180005','00201505','00223005']#,'00210005','00223005','00234505']
titles = ['10:30','13:30','15:45','18:00','20:15','22:30']#,'23:45']


#fig, ((axs1,axs2),(ax1, ax2), (ax3, ax4), (ax5, ax6)) = plt.subplots(8,2, subplot_kw={'projection': ccrs.PlateCarree()}, figsize = (20,5))
fig, ((axs1,axs2),(ax1, ax2),(ax3, ax4),(ax5, ax6)) = plt.subplots(4,2, subplot_kw={'projection': ccrs.PlateCarree()}, figsize = (4.8,6.7))#10))
...
#ax1.add_patch(rect)
ax.set_title(rl.capA+' MODIS Terra: 10:30',fontsize=9)
...
fn=imread(f)
ls=ax.imshow(fn,zorder=1, extent=[lon_0,lon_1,lat_0,lat_1], origin='upper')
ax.set_title(rl.capB+' MODIS Aqua: 13:30',fontsize=9)
...
labels = [rl.capA, rl.capB,rl.capC,rl.capD,rl.capE,rl.capF,rl.capG,rl.capH,'(i.)','(j.)','(k.)','(l.)']
...
for n in range(0,6):
  ...
  cmap = cmx.get_cmap('Greys')#rainbow')#'Greys')#_r')
  norm = BoundaryNorm(level, ncolors=cmap.N, clip=False)
...
fig.subplots_adjust(right=0.8)
cbar_ax = fig.add_axes([0.82, 0.1, 0.03, 0.28])  #left, bottom, width, height as fractions of figure dimensions
cbar =  fig.colorbar(cs, cax=cbar_ax)
cbar.set_label("Outgoing TOA longwave" + rl.W_m_Sq)
fig.subplots_adjust(left=0.2)
#fig.tight_layout()
#plt.subplots_adjust(wspace=None, hspace=None)
#plt.setp(ax2.get_yticklabels(), visible=False)
#plt.setp(ax1.get_yticklabels(), visible=False)
#ax1.text(0.6,0.8,rl.capA+' M92',transform=ax1.transAxes,color='white')#,bbox=dict(facecolor='white'))#,fontsize=12)
print 'Save figure'
fig_name = fig_dir + 'LW_timeseries_'+abbrev+'.png'
