...
for i in range(0,5):
    ...
    #x.append(patch)
axb.legend(handles=x,loc='upper right', numpoints=1,fontsize=9)#,bbox_to_anchor = (1.01,0))
...
fig_name = fig_dir + 'FOR_PAPER_SCI_ADV_reflectivity_and_slope_MPHYSSLOPEFIG.png'
fig.tight_layout()
#fig.subplots_adjust(wspace=0, hspace=1)
