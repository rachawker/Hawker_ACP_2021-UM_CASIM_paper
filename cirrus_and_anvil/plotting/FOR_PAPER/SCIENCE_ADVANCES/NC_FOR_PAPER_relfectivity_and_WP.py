...
axc = plt.subplot2grid((3,1),(1,0))#,rowspan=2)#,colspan=2)
...
axa.legend(handles=x,loc='upper left',bbox_to_anchor=(0.31,0.98),ncol=2, fontsize=8)
...
fig_name = fig_dir + 'FOR_PAPER_SCI_ADV_reflectivity_and_WP.png'
fig.tight_layout()
