...
axhom.set_title(rl.capE+' Ice crystal water path')#, fontsize=8)
...
axhom.locator_params(nbins=5, axis='x')
axhom.set_title(rl.capF+' CDNC at 5 km')#, fontsize=8)
...
axhom.locator_params(nbins=5, axis='x')
axhom.set_title(rl.capD+' Outgoing radiation \n(cloudy regions) and INP')#, fontsize=8)
...
for x in range(0, len(WPS)):
  ...
  axhom.locator_params(nbins=5, axis='x')
  axhom.set_title(rl.capC+' Cloud SW reflectivity and WP')#, fontsize=8)
  #axhom.set_ylim(620,670)
...
axhom.locator_params(nbins=5, axis='x')
axhom.set_title(rl.capA+' Outgoing radiation \n(cloudy regions): INP impact')#, fontsize=8)
...
axg.set_ylim(-1,11)
plt.setp(axhom.get_xticklabels(), visible=True)
axhom.set_title(rl.capB+' In-cloud water path: INP impact')
