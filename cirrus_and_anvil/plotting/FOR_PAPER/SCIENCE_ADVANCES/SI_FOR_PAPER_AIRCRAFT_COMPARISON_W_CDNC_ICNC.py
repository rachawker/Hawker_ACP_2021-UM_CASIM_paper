...
plot_1d_histogram_aircraft_and_model(ax1,air_up_ic,updrafts,'w '+rl.m_per_s,rl.capA+' Vertical wind')
...
air_CDNC = air_CDNC
#updrafts = ra.read_in_nc_variables(data_path+rl.UPDRAFT_3D_file,rl.UPDRAFT_3D_var)
make_2D_hist_overlay_aircraft_two(ax2,updrafts,CDNC,air_up_ic,air_CDNC,rl.capB+' Vertical wind and CDNC','w '+rl.m_per_s,'CDNC '+rl.per_cm_cubed)#,fig_dir,'2D_hist_with_aircraft_data_W_v_CDNC')
ax2.set_ylim(0,80)
ax2.set_xlim(-5,12)
...
make_2D_hist_overlay_aircraft(ax3,ALT,ICNC,air_alt,aICNC,rl.capC+' Altitude and ICNC','Altitude '+rl.km,'ICNC'+rl.per_cm_cubed)
...
fig.tight_layout()
fig.subplots_adjust(right=0.8)
fig_name = fig_dir + 'SI_FOR_PAPER_SCI_ADV_AIRCRAFT_COMPARISON_W_CDNC_ICNC.png'
