...
axb.set_title(rl.capA+' Outgoing shortwave: SIP impact')
axa.set_title(rl.capB+' Outgoing longwave: SIP impact')
...
axb.legend(handles=x,loc='upper center',ncol=2, fontsize=9)
fig_name = fig_dir + 'SI_FOR_PAPER_BAR_CHART_SW_LW_HM.png'
fig.tight_layout()
