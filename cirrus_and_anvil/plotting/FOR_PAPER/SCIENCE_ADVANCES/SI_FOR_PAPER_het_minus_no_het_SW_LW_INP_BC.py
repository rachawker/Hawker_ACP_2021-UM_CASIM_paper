...
fig_dir = '/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_time_series/FOR_PAPER/SCIENCE_ADVANCES/SI/'#rl.cirrus_and_anvil_fig_dir
...
axb.set_ylabel(r'$\Delta$'+ ' SW '+rl.W_m_Sq)
...
axa.set_ylabel(r'$\Delta$'+ ' LW '+rl.W_m_Sq)
axb.set_title(rl.capA+' Outgoing shortwave: INP impact')
axa.set_title(rl.capB+' Outgoing longwave: INP impact')
#axc.set_title('(c.) Total outgoing radiation')
...
#axb.set_ylabel(r'$\Delta$'+ ' (SW + LW) '+rl.W_m_Sq)
...
axb.legend(handles=x,loc='upper left',ncol=3, fontsize=9)
fig_name = fig_dir + 'SI_FOR_PAPER_BAR_CHART_SW_LW_INP.png'
fig.tight_layout()
