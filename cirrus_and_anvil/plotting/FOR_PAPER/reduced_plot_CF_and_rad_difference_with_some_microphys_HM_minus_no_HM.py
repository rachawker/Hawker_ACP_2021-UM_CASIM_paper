...
axb = plt.subplot2grid((5,6),(3,0),rowspan=2,colspan=2)#(2,3),(0,1))#,colspan=2)
...
#total outgoing rad
axd = plt.subplot2grid((5,6),(3,2),rowspan=2,colspan=3)
axf = plt.subplot2grid((5,6),(3,5),rowspan=2)
barWidth = 0.13
...
axb.set_title('(d.) Domain cloud fraction')
...
axf.legend(handles=x,loc='upper right',fontsize=9)
#axd.legend(handles=x,bbox_to_anchor=(1.3,0.1),loc='lower left')
axf.axis('off')
axd.set_title('(e.) Total outgoing radiation')



fig_name = fig_dir+'/reduced_plot_CF_and_rad_with_some_microphys_HM_minus_noHM_diff.png'
