...
fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2,2, subplot_kw={'projection': ccrs.PlateCarree()}, figsize = (7.8,5.4))
  ###PLOT MODEL DATA
...
print 'Save figure'
fig_name = fig_dir + 'High_cloud_2D_difference_4_panel_'+date+'.png'
