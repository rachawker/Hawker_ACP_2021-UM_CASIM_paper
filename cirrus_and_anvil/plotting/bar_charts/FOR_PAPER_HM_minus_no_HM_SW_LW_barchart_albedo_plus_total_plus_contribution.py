...
for i in range(0,5):
    ...
    x.append(patch)
axa.text(0.02,0.9,ax_lab1[1],transform=axa.transAxes,fontsize=9)
axb.legend(handles=x,loc='lower left',ncol=2, columnspacing=0.5,fontsize=9)
fig_name = fig_dir + 'BAR_CHART_cloud_contributions_and_total_radiation_difference_HM_minus_noHM_diff.png'
fig.tight_layout()
