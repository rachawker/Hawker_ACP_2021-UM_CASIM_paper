...
for i in range(0,5):
    ...
    x.append(patch)
ax_lab1 = ['(a)','(b)','(c)']
axb.text(0.21,0.9,ax_lab1[0],transform=axb.transAxes,fontsize=9)
axa.text(0.02,0.1,ax_lab1[1],transform=axa.transAxes,fontsize=9)
axb.legend(handles=x,loc='upper left', fontsize=9)
fig_name = fig_dir + 'BAR_CHART_cloud_contributions_and_total_radiation_difference_het_minus_nohet_diff.png'
fig.tight_layout()
