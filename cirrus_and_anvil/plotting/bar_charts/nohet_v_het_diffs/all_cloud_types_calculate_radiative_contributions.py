...
for f in range(0,len(list_of_dir)-1):
 for n in range(0,len(sw_rad_names)): 
  ...
  domain_diff_outgoing_rad_array[f,n] = domain_diff_outgoing_rad
  ...
  cloud_albedo_diff_array[f,n] = cloud_albedo_diff
...
print cf_diff_array
print 'ref cf'
print ref_run_cf_array
print 'sens cf'
print sensitivity_run_cf_array
print 'cloud_albedo_diff_array'
print cloud_albedo_diff_array
print 'ref_run_reflectivity_array'
print ref_run_reflectivity_array
print 'ref_run_clear_reflectivity_array'
print 'clear_albedo_diff_array'
print clear_albedo_diff_array
print 'domain_diff_outgoing_rad_array'
print domain_diff_outgoing_rad_array
'''
##albedo_contribution
...
print 'clear+other cloud'
print proportion_clear_sky_contribution
'''
print 'sum proportions, should be = about 1'
print proportion_albedo_contribution+proportion_cf_contribution+proportion_interaction_contribution+proportion_clear_sky_contribution

perfect = np.ones((5,8))
added_proportions = (albedo_contribution+cf_contribution+interaction_contribution+clear_sky_contribution)/domain_diff_outgoing_rad_array
diff_from_perfection = added_proportions - perfect

#(albedo_contribution+cf_contribution+interaction_contribution+clear_sky_contribution)/domain_diff_outgoing_rad_array
...
cloud_ref = mean_cf[5]
cf_arrays = [cloud_ref for _ in range(5,8)]
...
sw_arrays = [sw_ref for _ in range(5,8)]
