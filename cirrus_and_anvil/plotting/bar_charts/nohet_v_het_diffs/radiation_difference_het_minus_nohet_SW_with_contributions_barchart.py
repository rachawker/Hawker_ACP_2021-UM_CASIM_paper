...
axa.legend(handles=x,loc='upper left', fontsize=9)

axa.set_ylabel(r'$\Delta$'+ ' SW TOA outgoing \nradiation  '+rl.W_m_Sq)
...
fig_name = fig_dir + 'BAR_CHART_SW_all_contributions_radiation_difference_het_minus_nohet_diff.png'
fig.tight_layout()
