...
cloud_fracs_file = rl.rad_lmh_file
cloud_fracs = rl.rad_lw
...
csv_name = 'Average_LW_all_low_mid_high_cloud.py'
array = np.zeros((10,3))
...
fig.tight_layout()
fig_name = fig_dir + 'low_mid_high_LW.png'
plt.savefig(fig_name, format='png', dpi=1000)
plt.show()
   

csv_name = 'HM_minus_noHM_LW_CHANGE_all_low_mid_high_cloud'
array = np.zeros((5,3))
...
axT.set_xlabel('Time (hr)')
fig.tight_layout()
fig_name = fig_dir + 'low_mid_high_LW_diff_Param_minus_noHM.png'
plt.savefig(fig_name, format='png', dpi=1000)
plt.show()

#shortwave
cloud_fracs_file = rl.rad_lmh_file
cloud_fracs = rl.rad_sw

csv_name = 'Average_SW_all_low_mid_high_cloud.py'
array = np.zeros((10,3))
...
axT.set_xlabel('Time (hr)')
fig.tight_layout()
fig_name = fig_dir + 'low_mid_high_SW.png'
plt.savefig(fig_name, format='png', dpi=1000)
plt.show()


csv_name = 'HM_minus_noHM_SW_CHANGE_all_low_mid_high_cloud'
array = np.zeros((5,3))
...
axT.set_xlabel('Time (hr)')
fig.tight_layout()
fig_name = fig_dir + 'low_mid_high_SW_diff_Param_minus_noHM.png'
plt.savefig(fig_name, format='png', dpi=1000)
plt.show() 
