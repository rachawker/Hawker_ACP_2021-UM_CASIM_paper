...
cloud_fracs = rl.one_cloud_level_area
...
fig.tight_layout()
fig_name = fig_dir + 'low_mid_high_cloud_fraction_of_same_type_absolute_area.png'
...
axT.set_xlabel('Time (hr)')
fig.tight_layout()
fig_name = fig_dir + 'low_mid_high_cloud_fraction_of_same_type_absolute_area_Param_minus_no_HM.png'
plt.savefig(fig_name, format='png', dpi=1000)
plt.show() 
