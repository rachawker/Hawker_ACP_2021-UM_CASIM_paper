...
mass_title=['Freezing rate','Freezing rate','Freezing rate']
units = [rl.per_m_cubed_per_s,rl.per_m_cubed_per_s_by_1000,rl.per_m_cubed_per_s]
...
display = (0,1,2,3,4,5)
ax3.legend(bbox_to_anchor=(0.95, 0.4))#, fontsize=7.5)
ax1.set_ylabel('Height (km)', fontsize=9)
ax1.set_xlim(10e-7,10e4)
