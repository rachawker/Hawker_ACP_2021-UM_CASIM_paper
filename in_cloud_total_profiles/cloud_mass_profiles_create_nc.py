...
def cloud_mass_write_nc(data_path):
    ...
    for t in np.arange(start_time*60,end_time*60-1,dt_output[m]):
      ...
      ice_crystal_mmr[cloud_mass<10e-6]=np.nan
      snow_mmr[cloud_mass<10e-6]=np.nan
      graupel_mmr[cloud_mass<10e-6]=np.nan
      ice_water_mmr[cloud_mass<10e-6]=np.nan
      CD_mmr[cloud_mass<10e-6]=np.nan
    ...
    out_file = data_path+'netcdf_summary_files/in_cloud_profiles/cloud_mass_profiles.nc'
