...
for r in range(0, len(cloud_mass)):
  ...
  for f in range(0,6):
    ...
    file2 = data_path+'/um/netcdf_summary_files/in_cloud_profiles/one_cloud_level_only/high_cloud_only/hydrometeor_number_profiles.nc'
...
fig_name = fig_dir + 'EFFECTIVE_RADIUS_PARAM_and_DIFF_ice_snow_graupel_profiles.png'
plt.savefig(fig_name, format='png', dpi=400)
plt.show()
 # plt.close()
