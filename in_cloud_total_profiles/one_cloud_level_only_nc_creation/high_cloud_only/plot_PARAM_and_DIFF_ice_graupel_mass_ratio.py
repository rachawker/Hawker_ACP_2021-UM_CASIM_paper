...
for r in range(0, 1):
  ...
  axhom.set_xlabel('Ice/Graupel mass ratio', fontsize=8, labelpad=10)
  axhom.set_ylim(9,16)
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_ICE_to_GRAUPEL_RATIO_in_cloud_mean_profiles.png'
...
for r in range(0,1):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_DIFFERENCE_HM_minus_noHM_ICE_to_GRAUPEL_RATIO_in_cloud_mean_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
