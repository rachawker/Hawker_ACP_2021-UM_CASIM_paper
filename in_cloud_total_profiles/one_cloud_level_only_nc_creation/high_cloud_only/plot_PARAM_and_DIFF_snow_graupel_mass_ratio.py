...
for r in range(0, 1):
  ...
  for f in range(0,len(list_of_dir)):
    ...
    print data_path
    file1=data_path+'/um/netcdf_summary_files/in_cloud_profiles/one_cloud_level_only/high_cloud_only/cloud_mass_profiles.nc'
    rain = ra.read_in_nc_variables(file1,'snow_mmr')
  ...
  axhom.set_xlabel('Snow/Graupel mass ratio', fontsize=8, labelpad=10)
  axhom.set_ylim(9,16)
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_SNOW_to_GRAUPEL_RATIO_in_cloud_mean_profiles.png'
...
for r in range(0,1):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_DIFFERENCE_HM_minus_noHM_SNOW_to_GRAUPEL_RATIO_in_cloud_mean_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
