...
cloud_file = ['/um/netcdf_summary_files/in_cloud_profiles/one_cloud_level_only/high_cloud_only/hydrometeor_number_profiles.nc','/um/netcdf_summary_files/in_cloud_profiles/one_cloud_level_only/high_cloud_only/cloud_mass_profiles.nc','/um/netcdf_summary_files/in_cloud_profiles/one_cloud_level_only/high_cloud_only/cloud_mass_profiles.nc']
...
units = [rl.per_m_cubed,rl.kg_per_m_cubed,rl.kg_per_m_cubed_by_minus_10000]
...
fig_dir= '/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_time_series/in_cloud_profiles/one_cloud_level_only/high_cloud_only/'
...
display = (0,1,2,3,4,5)
ax5.legend(loc='upper right')#bbox_to_anchor=(0.7, 0.85), fontsize=7.5)
ax1.set_ylabel('Height (km)', fontsize=9)
plt.setp(ax3.get_yticklabels(), visible=False)
plt.setp(ax5.get_yticklabels(), visible=False)
fig.tight_layout()
fig_name = fig_dir + 'PARAM_ice_number_mass_snow_graupel_mass_profiles.png'
