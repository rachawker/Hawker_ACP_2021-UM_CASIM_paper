...
axhom.set_xlabel('Fraction frozen (%)', fontsize=8, labelpad=10)
axhom.set_ylim(0,16000)
axhom.locator_params(nbins=5, axis='x')
axhom.set_title('Fraction frozen', fontsize=8)
#fig.tight_layout()
fig_name = fig_dir + 'PARAM_ONLY_fraction_frozen_in_cloud_mean_profiles.png'
...
axhom.set_title('Fraction frozen', fontsize=8)
#fig.tight_layout()
fig_name = fig_dir + 'PARAM_ONLY_fraction_frozen_LOG_SCALE_in_cloud_mean_profiles.png'
plt.savefig(fig_name, format='png', dpi=400)
plt.show()
...
axhom.set_xlabel('Fraction frozen (%)', fontsize=8, labelpad=10)
axhom.set_ylim(0,16000)
#axhom.set_xlim(-0.02,0.02)
axhom.locator_params(nbins=5, axis='x')
axhom.set_title('Difference HM minus no HM', fontsize=8)
#fig.tight_layout()
fig_name = fig_dir + 'PARAM_ONLY_DIFFERENCE_HM_minus_noHM_fraction_frozen_in_cloud_mean_profiles.png'
plt.savefig(fig_name, format='png', dpi=400)
plt.show()
