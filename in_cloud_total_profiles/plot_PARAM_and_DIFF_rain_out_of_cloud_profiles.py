...
cloud_mass = ['domain_out_of_cloud_rain_mmr','rainy_areas_out_of_cloud_rain_mmr']

mass_title =['Rain mass out of cloud domain','Rain mass out of cloud rainy areas']
mass_name =['domain_out_of_cloud_rain_mmr','rainy_areas_out_of_cloud_rain_mmr']
...
for r in range(0, len(cloud_mass)):
  ...
  for f in range(0,len(list_of_dir)):
    ...
    print data_path
    file1=data_path+'/um/netcdf_summary_files/in_cloud_profiles/rain_out_of_cloud_profiles.nc'
  ...
  axhom.set_xlabel(mass_title[r]+" "+rl.m_per_s, fontsize=8, labelpad=10)
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_'+mass_name[r] + '_out_of_cloud_profiles.png'
...
for r in range(0, len(cloud_mass)):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'DIFFERENCE_HM_minus_noHM_'+mass_name[r] + '_out_of_cloud_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
...
for r in range(0, len(cloud_mass)):
  ...
  for f in range(0,len(HM_dir)):
    ...
    #data_path = INP_dir[f]
    #print data_path
    file1='/group_workspaces/jasmin2/asci/rhawker/ICED_b933_case/HOMOG_and_HM_no_het/um/netcdf_summary_files/in_cloud_profiles/rain_out_of_cloud_profiles.nc'
    nc1 = netCDF4.Dataset(file1)
    fr2 = nc1.variables[cloud_mass[r]]
    fr2 = np.asarray(fr2)
    fr2 = fr2[24:,:]
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'DIFFERENCE_INP_minus_noINP_'+mass_name[r] + '_out_of_cloud_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
