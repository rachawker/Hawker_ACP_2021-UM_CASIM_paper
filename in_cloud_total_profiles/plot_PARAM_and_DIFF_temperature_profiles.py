...
line_HM = ['--','--','--','--','--','--']
#No_het_line = ['-.',':']
labels = ['Cooper 1986','Meyers 1992','DeMott 2010','Niemand 2012', 'Atkinson 2013','No INP']
#label_no_het = ['No param, HM active', 'No param, No HM']
name = ['Cooper_1986','Meyers_1992','DeMott_2010','Niemand_2012','Atkinson_2013','NoINP']
...
for r in range(0, len(cloud_mass)):
  ...
  axhom.set_xlabel(mass_title[r]+" "+rl.Kelvin, fontsize=8, labelpad=10)
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_'+mass_name[r] + '_domain_mean_profiles.png'
...
for r in range(0, len(cloud_mass)):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_DIFFERENCE_HM_minus_noHM_'+mass_name[r] + '_domain_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
...
for r in range(0, len(cloud_mass)):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_DIFFERENCE_PARAM_minus_noPARAM_'+mass_name[r] + '_domain_mean_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
