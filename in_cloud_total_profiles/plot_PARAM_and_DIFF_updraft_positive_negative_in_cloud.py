...
for r in range(0, len(cloud_mass)):
  ...
  axhom.set_xlabel(mass_title[r]+" (positive) "+rl.m_per_s, fontsize=8, labelpad=10)
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_'+mass_name[r] + '_positive_in_cloud_mean_profiles.png'
...
for r in range(0, len(cloud_mass)):
  ...
  for f in range(0,len(list_of_dir)):
    ...
    height = (nc1.variables['height'][:])/1000
    axhom.plot(fr1,height,c=col[f], linewidth=1.2, linestyle=line[f],label=labels[f])
  axhom.set_xlabel("Downdraft speed "+rl.m_per_s, fontsize=8, labelpad=10)
  #axhom.legend(bbox_to_anchor=(2.02, 0.35), fontsize=7.5)
  axhom.set_ylabel('Height (m)', fontsize=8)
  axhom.set_ylim(0,16)
  axhom.locator_params(nbins=5, axis='x')
  axhom.set_title(mass_name[r], fontsize=8)
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_'+mass_name[r] + '__negative_in_cloud_mean_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
  #plt.close()
...
for r in range(0, len(cloud_mass)):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'DIFFERENCE_HM_minus_noHM_'+mass_name[r] + '_positive_in_cloud_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
...
for r in range(0, len(cloud_mass)):
  ...
  axhom.set_ylabel('Height (m)', fontsize=8)
  axhom.set_ylim(0,16)
  axhom.set_xlabel(mass_title[r]+" (negative) "+rl.m_per_s, fontsize=8, labelpad=10)
  axhom.set_title('Difference HM minus no HM', fontsize=8)
  #fig.tight_layout()
  fig_name = fig_dir + 'DIFFERENCE_HM_minus_noHM_'+mass_name[r] + '_negative_in_cloud_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
...
for r in range(0, len(cloud_mass)):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'DIFFERENCE_INP_minus_noINP_'+mass_name[r] + '_positive_in_cloud_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
...
for r in range(0, len(cloud_mass)):
  ...
  axhom.set_title('Difference INP minus no INP', fontsize=8)
  #fig.tight_layout()
  fig_name = fig_dir + 'DIFFERENCE_INP_minus_noINP_'+mass_name[r] + '_negative_in_cloud_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
