...
for r in range(0, len(cloud_mass)):
  ...
  if r==0:
    ...
    axhom.set_xlabel(mass_title[r]+r" ($\mathrm{kg  kg{{^-}{^1}}}$)", fontsize=8, labelpad=10)
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_'+mass_name[r] + '_out_of_cloud_mean_profiles.png'
...
for r in range(0, len(cloud_mass)):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_DIFFERENCE_INP_minus_noINP_'+mass_name[r] + '_out_of_cloud_mean_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
...
for r in range(0, len(cloud_mass)):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'PARAM_ONLY_DIFFERENCE_HM_minus_noHM_'+mass_name[r] + '_out_of_cloud_mean_profiles.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
