...
col = ['dimgrey','mediumslateblue','cyan','greenyellow','forestgreen', 'brown','dimgrey']
line = ['-','-','-','-','-','-','--']
line_HM = ['--','--','--','--','--','--']
labels = ['Cooper 1986','Meyers 1992','DeMott 2010','Niemand 2012', 'Atkinson 2013', 'No ice nucleation','Cooper no mass cons']
#label_no_het = ['No param, HM active', 'No param, No HM']
name = ['Cooper_1986','Meyers_1992','DeMott_2010','Niemand_2012','Atkinson_2013','No_ice_nucleation','Cooper_mass_conservation_off']
...
fig.tight_layout()
fig_name = fig_dir + 'freezing_rates_for_paper_in_cloud_profiles_incl_Cooper_mass_cons_off.png'
