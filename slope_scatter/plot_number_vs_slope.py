...
with open('./cloud_hydrometeor_number_relationship_to_slope_summary.csv',mode='w') as slope_file:
 ...
 for r in range(0, len(cloud_mass)):
  for x in range(0,len(heights)):
   ...
   axhom.set_ylabel(ylab[r]+r" ($\mathrm{m{{^-}{^3}}}$)", fontsize=8, labelpad=10)
