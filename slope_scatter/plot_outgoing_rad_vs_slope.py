...
with open('./radiation_relationship_to_slope_summary.csv',mode='w') as slope_file:
 ...
 for r in range(0, len(cloud_mass)):
  ...
  axhom.set_ylabel(ylab[r]+rl.W_m_Sq, fontsize=8, labelpad=10)
 ...
 for r in range(0, len(cloud_mass)):
  ...
  #fig.tight_layout()
  fig_name = fig_dir + 'SCATTER_slope_vs_DIFF_TO_NO_INP_domain_'+cloud_mass_tit[r] + '.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
  #plt.close()
