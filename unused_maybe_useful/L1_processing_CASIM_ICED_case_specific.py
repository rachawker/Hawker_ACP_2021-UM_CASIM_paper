...
output_files_directory = '/group_workspaces/jasmin/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_run8_new_model_stash_codes/um/'
...
p_convert = iris.coords.AuxCoord(100000.0,long_name='convert_units',units='Pa')
...
temperature = air_pressure_nodim*potential_temperature 
