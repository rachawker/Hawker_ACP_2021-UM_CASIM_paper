...
label = ['DeMott 2010', 'Cooper 1986', 'Niemand 2012', 'Meyers 1992']
...
for f in range(0,len(list_of_dir)):
  ...
  rfile=data_path+'/um/All_time_steps/All_time_steps_m01s00i075_CLOUD_NUMBER_AFTER_TIMESTEP_________.nc'
#  sfile=data_path+'/um/All_time_steps/All_time_steps_m01s04i202_stratiform_snowfall_amount.nc'
  cdnc=iris.load_cube(rfile)
  print cdnc
  print np.amax(cdnc.data)

'''
  #snow=iris.load_cube(sfile)
  #rain_3D=iris.analysis.maths.add(rain, snow)
  rain_array = cdnc.data[:,:,:]
