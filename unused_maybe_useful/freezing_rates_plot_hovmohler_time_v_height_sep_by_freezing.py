...
list_of_species = ['heterogeneous_freezing', 'homogeneous_freezing', 'rain_freezing', 'secondary_freezing']

nc_var_names = ['hetero_no_by_z_mean','homog_no_by_z_mean','rain_no_by_z_mean','second_no_by_z_mean']



fig_dir= '/group_workspaces/jasmin/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_time_series/hovmoller_plots/freezing_rates/'


for i in range(0, len(list_of_species)):
#for i in range(0,1):
  if i==0:
    level = np.logspace(0,7,21)
   # level = np.linspace(0000001,i10000000,21)
  if i==1:
    level = np.logspace(2,6,21)
    #level = np.linspace(100,1000000,21)
  ...
  if i==2:
    ...
    level = np.logspace(-6,3,21)
  if i==3:
    #level = np.logspace(-4,6,20)
    level = np.linspace(0.0001,2000,21)
  if i==4:
    #level = np.logspace(-4,6,20)
...
####bad colorbar to see where hetero starts
list_of_dir = ['/group_workspaces/jasmin/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_INP2_Cooper1986','/group_workspaces/jasmin/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_INP5_Meyers1992','/group_workspaces/jasmin/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_INP1_DeMott2010','/group_workspaces/jasmin/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_INP3_Niemand2012', '/group_workspaces/jasmin/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_INP_NO_HALLET_MOSSOP_Meyers1992', '/group_workspaces/jasmin/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_INP_NO_HALLET_MOSSOP', '/group_workspaces/jasmin/asci/rhawker/ICED_b933_case/ICED_CASIM_b933_INP_HOMOGENEOUS_ONLY']
...
#for i in range(0,1):
  if i==0:
    level = np.logspace(0,7,21)
    level = np.linspace(0,10000000,21)
  if i==1:
    level = np.logspace(2,6,21)
    #level = np.linspace(100,1000000,21)
    #level = np.linspace(0,60000000,21)
 ...
 # fig.tight_layout()
#plt.xscale('log')
  fig_name = fig_dir + list_of_species[i] + 'BAD_CBAR_WHERE_DOES_IT_START_number_hovmoller_TIME_V_Z_plot.png'
  plt.savefig(fig_name, format='png', dpi=1000)
  #plt.show()
  plt.close()
