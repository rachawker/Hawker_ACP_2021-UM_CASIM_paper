...
fig.tight_layout()
#plt.xscale('log')
fig_name = fig_dir + 'hydrometeor_number_means_profiles_all_times_in_cloud_only_plot.png'
...
fig.tight_layout()
#plt.xscale('log')
fig_name = fig_dir + 'hydrometeor_number_means_profiles_after_6am_plot.png'
plt.savefig(fig_name, format='png', dpi=1000)
plt.show()
'''
