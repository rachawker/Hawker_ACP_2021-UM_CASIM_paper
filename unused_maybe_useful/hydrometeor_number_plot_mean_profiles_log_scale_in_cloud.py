...
fig.tight_layout()
#plt.xscale('log')
fig_name = fig_dir + 'hydrometeor_number_means_profiles_log_scale_all_times_in_cloud_only_plot.png'
...
axic = plt.subplot2grid((1,4),(0,0))
axs = plt.subplot2grid((1,4),(0,1))
axg = plt.subplot2grid((1,4),(0,2))
...
for f in range(0,len(list_of_dir)):
 # if f == 3:
  ...
  axs.plot(snow,height,c=col[f])
  axg.plot(gr,height,c=col[f],label=label[f])
  axg.legend(bbox_to_anchor=(1.05, 0.6), fontsize=5)
axic.set_xscale('log')
#axs.set_xscale('log')
#axg.set_xscale('log')

axic.set_xlim(10E-4,10E+7)
#axs.set_xlim(10E0,10E+6)
#axg.set_xlim(10E0,10E+6)
...
fig.tight_layout()
#plt.xscale('log')
fig_name = fig_dir + 'ice_phase_hydrometeor_number_means_profiles_log_scale_in_cloud_only_all_times_plot.png'
plt.savefig(fig_name, format='png', dpi=1000)
#plt.show()
plt.close()
...
fig.tight_layout()
#plt.xscale('log')
fig_name = fig_dir + 'ice_crystal_number_means_profiles_log_scale_all_times_in_cloud_only_plot.png'
plt.savefig(fig_name, format='png', dpi=1000)
plt.show()
#plt.close()
