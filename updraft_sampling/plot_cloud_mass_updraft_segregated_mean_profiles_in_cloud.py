...
for r in range(0, len(cloud_mass)):
  ...
  fig.tight_layout()
  #plt.xscale('log')
  fig_name = fig_dir + mass_name[r] + '_updraft_separated_in_cloud_mean_profiles.png'
...
for r in range(0, len(cloud_mass)):
 ...
 # if r == 3:
  ...
  fig.tight_layout()
  #plt.xscale('log')
  fig_name = fig_dir + mass_name[r] + '_LOG_SCALE_updraft_separated_in_cloud_mean_profiles.png'
  #fig_name = fig_dir + 'cloud_mass_timeseries_plot.png'
  plt.savefig(fig_name, format='png', dpi=400)
  plt.show()
 # plt.close()
